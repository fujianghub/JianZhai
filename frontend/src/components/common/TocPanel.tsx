          ...
          >
            <a
              ...
              style={{
                ...
                fontSize: 13,
                lineHeight: 1.45,
                color: activeId === entry.id ? 'var(--jz-doc-accent, var(--jz-accent))' : 'var(--jz-text-muted)',
                fontWeight: activeId === entry.id ? 600 : 400,
                borderLeft: `2px solid ${activeId === entry.id ? 'var(--jz-doc-accent, var(--jz-accent))' : 'transparent'}`,
                textDecoration: 'none',
                borderRadius: 2,
