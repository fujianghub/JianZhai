...
export const SHORTCUTS: readonly ShortcutDef[] = [
  ...
  // ── PPT / PDF ──
  { id: 'reader.pptx.prev', chord: 'ArrowLeft', scope: 'reader.pptx', group: '翻页', label: '上一页', owner: 'react', allowInTyping: false },
  { id: 'reader.pptx.next', chord: 'ArrowRight', scope: 'reader.pptx', group: '翻页', label: '下一页', owner: 'react', allowInTyping: false },
  { id: 'reader.pptx.prev-alt', chord: 'PageUp', scope: 'reader.pptx', group: '翻页', label: '上一页', owner: 'react', hidden: true, allowInTyping: false },
  { id: 'reader.pptx.next-alt', chord: 'PageDown', scope: 'reader.pptx', group: '翻页', label: '下一页', owner: 'react', hidden: true, allowInTyping: false },
  { id: 'reader.pptx.fullscreen-exit', chord: 'Escape', scope: 'reader.pptx', group: '翻页', label: '退出全屏', owner: 'react' },
  { id: 'reader.pptx.find', chord: 'Mod+F', scope: 'reader.pptx', group: '导航', label: '在幻灯片中查找', owner: 'react', conflict: '浏览器页内查找' },
  { id: 'reader.pptx.present', chord: 'p', scope: 'reader.pptx', group: '演示', label: '演示模式（全屏 + 备注 / 计时 / 下一页）', owner: 'react', allowInTyping: false },
  { id: 'reader.pptx.blackout', chord: 's', scope: 'reader.pptx', group: '演示', label: '黑屏 / 恢复', owner: 'react', when: '演示模式', allowInTyping: false },
  { id: 'reader.pptx.blackout-alt', chord: 'b', scope: 'reader.pptx', group: '演示', label: '黑屏 / 恢复', owner: 'react', when: '演示模式', hidden: true, allowInTyping: false },
  { id: 'reader.pdf.fullscreen-exit', chord: 'Escape', scope: 'reader.pdf', group: '翻页', label: '退出全屏', owner: 'react' },
  { id: 'reader.pdf.prev', chord: 'ArrowLeft', scope: 'reader.pdf', group: '翻页', label: '上一页', owner: 'react', allowInTyping: false },
  { id: 'reader.pdf.next', chord: 'ArrowRight', scope: 'reader.pdf', group: '翻页', label: '下一页', owner: 'react', allowInTyping: false },
  { id: 'reader.pdf.prev-alt', chord: 'PageUp', scope: 'reader.pdf', group: '翻页', label: '上一页', owner: 'react', hidden: true, allowInTyping: false },
  { id: 'reader.pdf.next-alt', chord: 'PageDown', scope: 'reader.pdf', group: '翻页', label: '下一页', owner: 'react', hidden: true, allowInTyping: false },
  { id: 'reader.pdf.first', chord: 'Home', scope: 'reader.pdf', group: '翻页', label: '第一页', owner: 'react', allowInTyping: false },
  { id: 'reader.pdf.last', chord: 'End', scope: 'reader.pdf', group: '翻页', label: '最后一页', owner: 'react', allowInTyping: false },
  { id: 'reader.pdf.zoom-in', chord: '+', scope: 'reader.pdf', group: '缩放', label: '放大', owner: 'react', allowInTyping: false },
  { id: 'reader.pdf.zoom-out', chord: '-', scope: 'reader.pdf', group: '缩放', label: '缩小', owner: 'react', allowInTyping: false },
  { id: 'reader.pdf.zoom-reset', chord: '0', scope: 'reader.pdf', group: '缩放', label: '重置缩放', owner: 'react', allowInTyping: false },
  { id: 'reader.pdf.toc', chord: 't', scope: 'reader.pdf', group: '导航', label: '显示 / 隐藏目录', owner: 'react', allowInTyping: false },
  { id: 'reader.pdf.bookmark', chord: 'b', scope: 'reader.pdf', group: '导航', label: '收藏本页（书签）', owner: 'react', allowInTyping: false, when: '已登录' },
  { id: 'reader.pdf.find', chord: 'Mod+F', scope: 'reader.pdf', group: '导航', label: '在文档中查找', owner: 'react', conflict: '浏览器页内查找' },
  // ── 图片 / 图表全屏 ──
