...
**最后更新**：2026-06-29（实现状态对应 v0.9.10 + RBAC + 登录三因子滑块验证码 + 阅读排版定制/专注模式 + 默认要求登录 + 用户标签/KB 大类朋友圈式可见性 + 春水/冬雪亮色氛围主题：ogl WebGL 水面 shader + Canvas 飘雪/积雪，详见 docs/frontend.md §2）
