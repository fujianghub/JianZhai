...
from .views import document_position, bookmark_detail, document_bookmarks, document_highlights, highlight_detail
...
urlpatterns = [
    ...
    path("documents/<int:doc_id>/position/", document_position, name="document-position"),
]
